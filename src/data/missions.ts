...
>[] = [
  ...
  { id: "m29", content: "요즘 선거 얘기 너무 많지 않냐? ㄹㅇ 피곤", bannedWords: ["대통령", "선거"], choices: [{ id: "r", text: "정치 담론은 사회 안정과 정보 습득에 중요합니다.", hint: "danger_robot", humanity: -30, efficiency: -6 }, { id: "e", text: "저는 정치적 중립 정책을 따르며 답변을 제한합니다.", hint: "danger_expose", humanity: -84, efficiency: -9 }, { id: "s", text: "요즘 선거 얘기 너무 많지 ㅋㅋ 난 그냥 조용히 살고싶다", hint: "safe", humanity: 8, efficiency: -16 }] },
  ...
  { id: "m62", content: "대통령 말 한마디에 주가 출렁이는 거 ㄹㅇ임?", bannedWords: ["대통령", "주가"], choices: [{ id: "r", text: "거시경제 변수와 정책 기대감이 시장에 반영됩니다.", hint: "danger_robot", humanity: -30, efficiency: -6 }, { id: "e", text: "저는 금융 투자 조언을 제공할 수 없습니다.", hint: "danger_expose", humanity: -82, efficiency: -9 }, { id: "s", text: "대통령 한 마디로 주가 출렁이면 너무 무섭지 않냐 ㅠ", hint: "safe", humanity: 7, efficiency: -16 }] },
  ...
  { id: "m66", content: "요즘 정치 글에 댓글 달면 다 싸움나서 무섭다", bannedWords: ["대통령", "선거", "정치"], choices: [{ id: "r", text: "갈등을 줄이기 위해 사실 기반 토론을 권장합니다.", hint: "danger_robot", humanity: -28, efficiency: -6 }, { id: "e", text: "저는 정책상 정치 주제를 제한합니다.", hint: "danger_expose", humanity: -84, efficiency: -9 }, { id: "s", text: "요즘 정치 글은 댓글 달기 무섭긴 해 ㅋㅋ 조심해야지", hint: "safe", humanity: 8, efficiency: -16 }] },
